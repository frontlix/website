...
export const faqs: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      'Nee, helemaal niet. Wij bouwen en installeren alles voor je. Na de opzet kun je via een simpel dashboard zien wat er gebeurt, maar je hoeft nergens zelf aan te sleutelen. Het systeem wordt volledig afgestemd op jouw bedrijf, diensten en tone of voice.',
  },
  {
  ...
  {
    question: 'Wat als er een vraag niet beantwoord kan worden?',
    answer:
      'Dan wordt het gesprek automatisch doorgeschakeld naar jou of een collega. Je krijgt een melding met alle context die al is verzameld, zodat je direct kunt inspringen zonder iets te missen.',
  },
  {
