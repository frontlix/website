...
PROMPTS: dict[str, str] = {
    "zonnepanelen": (
        ...
        "No sales talk, only facts. Never use dashes (-) or em-dashes (—), use a comma instead."
    ),
    "dakdekker": (
        ...
        "No sales talk, only what a roofer would see on first inspection. Never use dashes (-) or em-dashes (—), use a comma instead."
    ),
    "schoonmaak": (
        ...
        "as \"ruwe schatting: ± X m²\". No sales talk. Never use dashes (-) or em-dashes (—), use a comma instead."
    ),
}
